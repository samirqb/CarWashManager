...
@Entity(
    ...
    indices = [
        Index(value = ["id_acuerdo_de_pago_pk", "id_plan_compensacion_fk", "id_periodo_facturacion_fk", "id_moneda_fk"]),
        Index(value = ["id_plan_compensacion_fk"]),
        Index(value = ["id_periodo_facturacion_fk"]),
    ],
    foreignKeys = [
        ForeignKey(
